...
<?php
  if(isset($_POST['submit'])){
    $flash = New Flash();
    $flash->set_title('Bravo !')->set_type('green')->add_messages('Vous vous êtes bien inscrit : test')->add_messages('Vous vous êtes bien inscrit : test')->add_messages('Vous vous êtes bien inscrit : test')->put();
